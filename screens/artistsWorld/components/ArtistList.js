...
class App extends Component {
    ...
    getData() {
        ...
        Api('get', ARTISTS_LIST + `?categoryId=${this.state.country.categoryId}` + `&language=${language}&page=${page}`)
            .then((responseJson) => {
                if (responseJson) {
    ...
    searchItem(keyword) {
        ...
        Api('post', ARTISTS_LIST + `?language=${language}` + `&categoryId=${this.state.country.categoryId}`, data)
            .then((response) => {
                        ...
                        <ScrollView style={styles.mainContainer}>
                            ...
                            <View style={styles.header}>
                                ...
                                <View style={styles.iconHead}>
                                    <TouchableOpacity style={styles.gridView} onPress={() => this.props.navigation.navigate('ArtistsWorldSub', { item: this.state.country })}>
                                        <Foundation name="page-multiple" size={19} />
                                    </TouchableOpacity>
                                <TouchableOpacity style={styles.gridView} onPress={() => this.props.navigation.navigate('CountryList',{country: this.state.country })}>
                                        <Entypo name="location" size={19} />
                                    </TouchableOpacity>
