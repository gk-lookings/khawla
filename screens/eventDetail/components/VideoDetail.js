...
class App extends Component {
    ...
    vimeoPlay() {
        if (this.state.videoUrl && this.state.videoUrl.includes('vimeo')) {
                        ...
                        {this.state.playing && this.state.videoLink != '' ?
                            ...
                            <TouchableOpacity style={styles.videoContainerMain} onPress={() => this.setState({ playing: true })}>
                                <View style={styles.imageVideoBG}>
                                    <Image style={styles.imageVideoImage} source={{ uri: event.eventCover }} />
                                </View>
                                <FontAwesome5 style={styles.videoIcon} name='play' size={40} color={PRIMARY_COLOR} />
                            </TouchableOpacity>}
                        <View style={styles.videoTitleContainer}>
                            <Text numberOfLines={1} style={styles.videoTitle}>{event.title}</Text>
                        </View>
                    </View>
                </ScrollView>
            </SafeAreaView>
