...
class App extends Component {
    ...
    getData() {
        ...
        Api('get', COLLABRATION + `?language=${language}`)
            .then((responseJson) => {
                if (responseJson) {
    ...
    renderArticle({ item }) {
        ...
        return (
            <TouchableOpacity onPress={() => this.props.navigation.navigate('CollabrationDetail', { item: item })} style={[styles.itemContainer, this.props.lang == 'en' && { flexDirection: 'row-reverse' }]}>
    ...
    renderArticleGrid({ item }) {
        ...
        // var newDescription = data.split('<br>').join('\n')
        return (
            <TouchableOpacity onPress={() => this.props.navigation.navigate('CollabrationDetail', { item: item })} style={styles.itemContainerGrid}>
