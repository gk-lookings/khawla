                    ...
                    >
                        {this.state.country.map(marker => (
                            <Marker
                                ...
                                title={marker.title}
                                onPress={() => this.props.navigation.navigate('ArtistsTree', { item: marker })}
                            />
                        ))}
                    </MapView>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('CertifiedCalligraphers')} style={styles.backButton}>
