...
class App extends Component {
  ...
  clearFields() {
    ...
    this.messageInput.clear(), this.setState({ emailValidate: true });
  }
        ...
        <View style={styles.mainContainer2}>
          {this.props.lang == "ar" && (
            <TouchableOpacity onPress={this.dialCall} style={styles.contactBox}>
              ...
              <Text numberOfLines={1} style={styles.contact}>
                {i18n.t("Phone")}: {i18n.t("_971_2_66_66_004")}+
              </Text>
              <Text numberOfLines={1} style={styles.contact}>
                {i18n.t("Fax")}: {i18n.t("_971_2_66_66_024")}+
              </Text>
            </TouchableOpacity>
          )}
          ...
          {this.props.lang == "en" && (
            <TouchableOpacity onPress={this.dialCall} style={styles.contactBox}>
              ...
              />
              <Text numberOfLines={1} style={styles.contact}>
                {i18n.t("Phone")}: +971 2 66 66 004
              </Text>
              <Text numberOfLines={1} style={styles.contact}>
                {i18n.t("Fax")}: +971 2 66 66 024
              </Text>
            </TouchableOpacity>
          )}
          <View
          ...
          />
          <TouchableOpacity
            onPress={() => Linking.openURL("mailto:info@khawlafoundation.com?")}
