...
class App extends Component {
  ...
  saveAddress() {
    ...
    Api(
      "post",
      "https://www.kaac.academy/api/json_user_shippinginfos.php",
      formD
    ).then((response) => {
        ...
        {this.state.isLoading ? (
          ...
          <View style={{ flex: 1 }}>
            ...
            >
              ...
              <View>
                ...
                {this.state.artDetail.isForSale == 1 &&
                  this.state.artDetail.price &&
                  this.state.artDetail.price != " " && (
                    <Text
                      style={[
                        styles.titleEventPrice,
                        this.props.lang == "ar" && { textAlign: "right" },
                        { paddingLeft: 10, marginTop: 10 },
                      ]}
                    >
              ...
              {this.state.artistDetails != "" && (
                <View>
                  ...
                  <View style={styles.artistContainer}>
                    <Image
                      source={{ uri: this.state.artistDetails.picture }}
                    ...
                    <View>
                      ...
                      <Text style={styles.artistDetail}>
                        {this.state.artistDetails.shortDescription}
                      </Text>
                    </View>
                    <TouchableOpacity
                      onPress={() =>
              ...
              {artDetail.videoAvailable == 1 && (
                ...
                >
                  <Text
                    style={[
                      styles.video,
                      this.props.lang == "en" && { alignSelf: "flex-start" },
                    ]}
                  >
                    {i18n.t("Video")}
                  </Text>
              ...
              {artDetail.qrPicture && artDetail.qrPicture != "" && (
                <View style={styles.qrContainer}>
                  <Image
                    ...
                    source={{ uri: artDetail.qrPicture }}
                  />
                </View>
              )}
              <Modal
              ...
              <Modal
                ...
                backdropOpacity={0.7}
                onBackButtonPress={() =>
                  this.setState({ isVisiblePrice: false })
                }
              ...
              >
                <View style={styles.contactConatainer}>
                  <TouchableOpacity
                    onPress={() => this.setState({ isVisiblePrice: false })}
                  >
                    <AntDesign
                      name="closecircleo"
                      size={20}
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      this.setState({ isSend: true }, () => this.onSend())
                    }
                    style={styles.send}
                  >
              ...
              >
                ...
                >
                  ...
                  >
                    <Image
                      resizeMode="contain"
                      source={{ uri: artDetail.artPicture }}
                    ...
                    <View style={{ marginLeft: 20 }}>
                      ...
                      >
                        Shipping cost : {this.state.buyDetails.shippingCost}
                      </Text>
                      <Text
                        style={{ fontSize: 13, fontFamily: FONT_MULI_REGULAR }}
                      >
                        Tax : {this.state.buyDetails.tax}
                      </Text>
                      <Text
                        style={{
                          fontSize: 15,
                  ...
                  >
                    ...
                    {!this.state.changeLoader ? (
                      <TouchableOpacity
                        onPress={() =>
                          this.setState(
                            { buyModel: false, changeLoader: true },
                            this.changeModel()
                          )
                        }
                    ...
                    >
                      <Text style={[styles.categoryText, { lineHeight: null }]}>
                        {this.state.itemAddress &&
                          this.state.itemAddress.shippingAddress1}{" "}
                      </Text>
                      <View
                        style={{
                          width: 1,
                      ...
                      <Text style={[styles.categoryText, { lineHeight: null }]}>
                        {" "}
                        {this.state.itemAddress &&
                          this.state.itemAddress.shippingAddress2}
                      </Text>
                    </View>
                    <Text style={styles.categoryText}>
                      <Text style={{ color: SECONDARY_COLOR, fontSize: 14 }}>
                      ...
                      {this.state.itemAddress && this.state.itemAddress.email}
                    </Text>
                    <Text style={styles.categoryText}>
                      <Text style={{ color: SECONDARY_COLOR, fontSize: 14 }}>
                        Mobile:
                      </Text>{" "}
                      {this.state.itemAddress && this.state.itemAddress.mobile}
                    </Text>
                    <Text style={styles.categoryText}>
                      <Text style={{ color: SECONDARY_COLOR, fontSize: 14 }}>
                        Telephone:
                      ...
                      {this.state.itemAddress &&
                        this.state.itemAddress.telephone}
                    </Text>
                  </View>
                ...
                >
                  ...
                  >
                    <AntDesign
                      ...
                      color={PRIMARY_COLOR}
                    />
                    <Text style={styles.addAddressTitle1}>
                      {" "}
                      Add new address
                    </Text>
                  </TouchableOpacity>
                ...
                <View style={styles.modalContainer}>
                  ...
                  <View style={styles.modalFooter}>
                    <TouchableOpacity
                      ...
                      onPress={() => this.setState({ isVisibleLogin: false })}
                    >
            ...
            {this.state.artDetail.isForSale == 0 && (
              <TouchableOpacity
                onPress={() => this.setState({ isVisiblePrice: true })}
